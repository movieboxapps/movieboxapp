...
export default function Hero() {
  ...
  const handleScrollToFeatures = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      console.warn("Scroll to features error:", err);
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left space-y-6">
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl font-display font-extrabold tracking-tight leading-tight text-white"
            >
